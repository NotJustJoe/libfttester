...
/*   Updated: 2021/10/11 11:06:18 by trofidal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
	...
	trofidal.tripouilleCheck(fakeSubstr, 3);ft_strcpy(tempFake, fakeSubstr);ft_strcpy(tempReal, realSubstr);free(fakeSubstr); free(realSubstr);trofidal.showLeaks(strcmp(tempReal, tempFake) == 0 ? 1 : 0, strlen(tempReal) == strlen(tempFake));
	...
	trofidal.tripouilleCheck(fakeSubstr, 18);ft_strcpy(tempFake, fakeSubstr);ft_strcpy(tempReal, realSubstr);free(fakeSubstr); free(realSubstr);trofidal.showLeaks(strcmp(tempReal, tempFake) == 0 ? 1 : 0, strlen(tempReal) == strlen(tempFake));
	...
	trofidal.tripouilleCheck(fakeSubstr, 17);ft_strcpy(tempFake, fakeSubstr);ft_strcpy(tempReal, realSubstr);free(fakeSubstr); free(realSubstr);trofidal.showLeaks(strcmp(tempReal, tempFake) == 0 ? 1 : 0, strlen(tempReal) == strlen(tempFake));
	...
	trofidal.tripouilleCheck(fakeSubstr, 21);ft_strcpy(tempFake, fakeSubstr);ft_strcpy(tempReal, realSubstr);free(fakeSubstr); free(realSubstr);trofidal.showLeaks(strcmp(tempReal, tempFake) == 0 ? 1 : 0, strlen(tempReal) == strlen(tempFake));
	...
	trofidal.tripouilleCheck(fakeSubstr, 2);ft_strcpy(tempFake, fakeSubstr);ft_strcpy(tempReal, realSubstr);free(fakeSubstr); free(realSubstr);trofidal.showLeaks(strcmp(tempReal, tempFake) == 0 ? 1 : 0, strlen(tempReal) == strlen(tempFake));
}