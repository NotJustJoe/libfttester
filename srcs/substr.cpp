...
/*   Updated: 2021/10/10 11:21:19 by trofidal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
    ...
    ataoiiiii, FIX ME THOMAS
    fakeSubstr = a("pendant (str[i])", 16, 17);realSubstr = b("pendant (str[i])" + 16, 17);
    /*6*/trofidal.t(fN, "pendant (str[i]), 16, 17");trofidal.tIntPtr(strcmp(fakeSubstr, realSubstr) == 0 ? 0 : 1, strlen(fakeSubstr) == strlen(realSubstr)); 
