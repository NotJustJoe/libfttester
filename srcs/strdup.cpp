...
/*   Updated: 2021/10/10 03:26:00 by trofidal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
    ...
    trofidal.tripouilleCheck(fakeStrdup, 1);free(fakeStrdup); free(realStrdup);trofidal.showLeaks( ret, retReal );
    ...
    trofidal.tripouilleCheck(fakeStrdup, 7);free(fakeStrdup); free(realStrdup);trofidal.showLeaks( ret, retReal );
    ...
    trofidal.tripouilleCheck(fakeStrdup, 17);free(fakeStrdup); free(realStrdup);trofidal.showLeaks( ret, retReal );
    ...
    trofidal.tripouilleCheck(fakeStrdup, 26);free(fakeStrdup); free(realStrdup);trofidal.showLeaks( ret, retReal );
    ...
    trofidal.tripouilleCheck(fakeStrdup, 35);free(fakeStrdup); free(realStrdup);trofidal.showLeaks( ret, retReal );
